package com.thedufresnegroup.adufres.qd_androidapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<BlogPost, BlogPostViewHolder> FBRA = new FirebaseRecyclerAdapter<BlogPost, BlogPostViewHolder>(
                BlogPost.class,
                R.layout.card_items,
